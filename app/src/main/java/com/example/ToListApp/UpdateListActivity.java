        ...
        update_datego.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(
                        UpdateListActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                                    ...
                                    db.collection("List")
                                            ...
                                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                ...
                                                public void onSuccess(Void aVoid) {
                                                    Toast.makeText(UpdateListActivity.this, "Succesfully Updated", Toast.LENGTH_SHORT).show();
                                                    finish();
                                                }
                                            }).addOnFailureListener(new OnFailureListener() {
                                        @Override
                                        public void onFailure(@NonNull Exception e) {
                                            Toast.makeText(UpdateListActivity.this, "Error Occured " + e, Toast.LENGTH_SHORT).show();
                                        }
                                    });
                                }
                            }else{
                                    Toast.makeText(UpdateListActivity.this, "Failed", Toast.LENGTH_SHORT).show();
                                }
                            }
                    });
        }
